...
name_ahc_nerwa =sorted(['BAMTA',	'BHALOO',	'BHARAN',	'BHARANU',	'C/BAG',	'DHAR CHANDNA',	'HALAU',	'JORNA',	'KHAGNA',	'KHAKHARONA',	'KIARNOO',	'MALTH',	'MAROG',	'NANHAR',	'PORIYA',	'PULBAHAL',	'SHAMTHA',	'SHILA BAWAT',	'TAILOR',	'TANDAI',	'TIKKAR'])
