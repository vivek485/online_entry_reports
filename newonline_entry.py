...
name_ahc_rampur = ['BATHARA',	'BHAMNOLI',	'BHAROG',	'DAGYANA',	'DANSA',	'DARAN',	'DARKALI',	'DELATH',	'DOFDA',	'DUTT NAGAR',	'GAHAN',	'GALANI',	'JAGORI',	'JAROL',	'JAWALDA',	'JUNI',	'KALEDA',	'KANDA',	'KANGAL',	'KANHAR',	'KASHAPAT',	'KATHINE',	'KHAMADI',	'KINNU',	'KKASHAPAT',	'KOOT',	'KUHAL',	'KUNGAL BALTI',	'LABANA',	'LOUGA',	'MAHOLI',	'MUNISH',	'NARAIN',	'NOGLI',	'PHANCHA',	'REOG',	'SANARSA',	'SARPARA',	'SHOLI',	'SURAD',	'THARU']
