...
#-------------------------------------------------------------------------
name_ahc = ['ANUAMBAPUR', 'AY.HOSP.ROHRU','AY.HOSP.RAMPUR','HHC RAH SHIMLA','BALOG', 'BANUTI DEVI', 'BEOLIA', 'BEUNTH', 'BHALOH', 'BHARARA', 'BHARARI', 'CHAKKAR', 'DABRI', 'DARGI', 'DHALLI', 'DUMMI', 'HIMRI', 'HIWAN', 'JABRI', 'JAKHOO', 'JATHIYA DEVI', 'KADHARGHAT', 'KAITHU', 'KALIHATTI', 'KANLOG', 'KHATNOL', 'LOWER BAZAR', 'MAJHIWAR', 'NABHA', 'NEW-SHIMLA', 'OLD JUNGA', 'PAHAL', 'PANTHAGHATI', 'PATGEHAR', 'PEERAN', 'RAMNAGAR', 'SANDOA', 'SANKATMOCHAN', 'SATLAI', 'SHOGHI', 'THAILA', 'TOTU', 'TUTIKANDI', 'U.H.C. LOWER BAZAR',
